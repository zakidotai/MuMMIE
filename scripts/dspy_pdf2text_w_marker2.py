...
API_KEYS = ['csk-y4d8c4k842c3cj3cxxxw6nrw5c4fhkrmf4pdmn33r9n58d84', 'csk-2y4fe35jvr332dthmhwkejcntekfxjtw6h3fw65rm6v5nycm',  'csk-r64dm5ry4h6n6nhjm3ht8mnyr88dfft4nfk3y8rd5nktvh6v']
...
pdf_files = sorted([f for f in os.listdir(minipdf_dir) if f.endswith('.pdf')])

for idx, pdf_filename in enumerate(pdf_files):
    
    configure_lm(provider="cerebras", model=model_name, api_key=API_KEYS[set_api_key(idx)], max_tokens=8192*8, temperature=0.0, timeout=200.0, top_p=0.90)
    ...
    if os.path.exists(json_path):
        ...
        if existing_data.get('answer') is not None:
            continue
